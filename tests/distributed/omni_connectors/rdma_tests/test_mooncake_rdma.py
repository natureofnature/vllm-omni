...
class TestMooncakeRDMAConnector(unittest.TestCase):
    ...
    def test_put_tensor(self):
        ...
        try:
            ...
            self.assertIn(req_id, connector._local_buffers)
            self.assertTrue(metadata["is_fast_path"])
            self.assertFalse(metadata["is_bytes"])
        finally:
            connector._stop_event.set()
            time.sleep(0.1)
    ...
    def test_put_bytes(self):
        ...
        try:
            ...
            self.assertTrue(metadata["is_fast_path"])
            self.assertTrue(metadata["is_bytes"])
        finally:
            connector._stop_event.set()
            time.sleep(0.1)
    ...
    def test_cleanup_releases_internal_buffer(self):
        ...
        try:
            ...
            self.assertNotIn(req_id, connector._local_buffers)
        finally:
            connector._stop_event.set()
            time.sleep(0.1)
...
class TestMooncakeRDMAEndToEnd(unittest.TestCase):
    ...
    def test_auto_cleanup_after_transfer(self):
        ...
        try:
            ...
            self.assertTrue(success)
            self.assertIn(req_id, producer._local_buffers)
            ...
            self.assertNotIn(req_id, producer._local_buffers)
...
class TestMooncakeRDMALifecycle(unittest.TestCase):
    ...
    def test_close_releases_resources(self):
        ...
        self.assertIn("req_close_test", connector._local_buffers)
