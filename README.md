...
vLLM were originally designed to support text-based, autoregressive generation. vLLM-omni extends its support for omni-modality model inference and serving:
